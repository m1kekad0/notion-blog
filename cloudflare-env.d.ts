/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 86e196072a1d5409fb17859423eef176)
// Runtime types generated with workerd@1.20260312.1 2026-03-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		BLOG_VIEWS_KV: KVNamespace;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_API_KEY" | "NOTION_DATABASE_ID" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_GISCUS_REPO" | "NEXT_PUBLIC_GISCUS_REPO_ID" | "NEXT_PUBLIC_GISCUS_CATEGORY" | "NEXT_PUBLIC_GISCUS_CATEGORY_ID">> {}
}
